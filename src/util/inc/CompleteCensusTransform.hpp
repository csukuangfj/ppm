/*  ---------------------------------------------------------------------
    ...
    -----------------------------------------------------------------  */
#ifndef _CompleteCensusTransform_HPP_
#define _CompleteCensusTransform_HPP_

#include <opencv2/core.hpp>

/**
 * Compute the complete census transform.
 *
 * Reference:
 ...
 * @param census_image_     [out] depth is CV_8U
 * @param wnd_size_         [in]  An odd number less than 16
 * @param color_to_gray_    [in] true to convert the color image to a gray image and compute the complete census
 *                               over the gray image.
 *                               false to compute the complete census over each channel and concatenate
...
#endif //_CompleteCensusTransform_HPP_
