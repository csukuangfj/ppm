/*  ---------------------------------------------------------------------
    ...
    -----------------------------------------------------------------  */
#ifndef _CpmImplProjectivePlanar_HPP_
#define _CpmImplProjectivePlanar_HPP_

#include "CpmImpl.hpp"

class CpmImplProjectivePlanar : public CpmImpl
{
public:
   CpmImplProjectivePlanar();
...
#endif //_CpmImplProjectivePlanar_HPP_
