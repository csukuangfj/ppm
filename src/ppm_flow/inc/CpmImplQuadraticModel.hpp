/*  ---------------------------------------------------------------------
    ...
    -----------------------------------------------------------------  */
#ifndef _CpmImplQuadraticModel_HPP_
#define _CpmImplQuadraticModel_HPP_

#include "CpmImpl.hpp"

class CpmImplQuadraticModel : public CpmImpl
{
public:
   CpmImplQuadraticModel();
...
#endif //_CpmImplQuadraticModel_HPP_
