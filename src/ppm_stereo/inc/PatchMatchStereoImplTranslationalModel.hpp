/*  ---------------------------------------------------------------------
    ...
    -----------------------------------------------------------------  */
#ifndef _PatchMatchStereoImplTranslationalModel_HPP_
#define _PatchMatchStereoImplTranslationalModel_HPP_

#include "PatchMatchStereoImpl.hpp"

class PatchMatchStereoImplTranslationalModel : public PatchMatchStereoImpl
{
public:
   PatchMatchStereoImplTranslationalModel();
...
#endif //_PatchMatchStereoImplTranslationalModel_HPP_
